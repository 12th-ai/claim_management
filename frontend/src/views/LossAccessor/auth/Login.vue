...
<script>
import { authService } from '../../../services/LossAccessor/Auth';
import AuthLeft from '../../../components/LossAccessor/AuthLeft.vue';
...
setTimeout(() => {
    this.$router.push('/LossAccessor/dashboard'); // Adjust the route as needed
