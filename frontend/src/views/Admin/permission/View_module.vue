        ...
        <tr v-for="module in filteredModules" :key="module.id" style="text-align:center">
          ...
          <td style="display:flex">
            <div class="hstack gap-3 fs-15" style="text-align:center;margin:auto; ">
              <a href="javascript:void(0);" @click="showModal('update', module)" class="link-primary" title="Update Module" :disabled="isFormDisabled" style="height:30px;width:30px;border-radius:5px;background-color:#9292ff88;padding-top:5px">
                <i class="ri-edit-line mt-8 mb-4" style=""></i>
              </a>
              <a href="javascript:void(0);" @click="confirmDelete(module.id)" class="link-danger" title="Delete Module" :disabled="isFormDisabled" style="height:30px;width:30px;border-radius:5px;background-color:#c06d7852;padding-top:5px">
                <i class="ri-delete-bin-5-line"></i>
              </a>
              <a href="javascript:void(0);" @click="toggleStatus(module)" class="link-warning" title="Toggle Status" :disabled="isFormDisabled" style="height:30px;width:30px;border-radius:5px;background-color:#75a9ee31;;padding-top:5px">
...
filteredModules() {
  return this.modules
    .filter(module =>
      module.module_name.toLowerCase().includes(this.searchName.toLowerCase()) || 
      module.description.toLowerCase().includes(this.searchName.toLowerCase())
    )
    .filter(module => {
      if (this.searchDate) {
