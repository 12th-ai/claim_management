...
<td>{{ new Date(company.createdAt).toLocaleDateString('en-GB').replace(/\//g, '-') }}</td>
 ...
 <td style="display:flex">
            <div class="hstack gap-3 fs-15" style="text-align:center;margin:auto">
                <!-- View More Button -->
  <router-link
  :to="{ name: 'review-company_detail', params: { id: company.id } }"
  class="link-primary"
  title="View More"
>
  <i class="ri-eye-line"></i> 
</router-link>
<a href="javascript:void(0);" @click="confirmDelete(company.id)" class="link-danger" title="Delete Company">
                <i class="ri-delete-bin-5-line"></i> 
              </a>
              <a href="javascript:void(0);" @click="showModal('update', company)" class="link-primary" title="Update Company">
